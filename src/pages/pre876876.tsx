...
const Pre876876: React.FC = () => {
  ...
  const renderVideo = (src: string, title: string, keyName: string) => (
    <div key={keyName}>
      <div style={{ textAlign: "center", margin: "20px 0 0" }}>
        ...
        <video
          ...
          style={{
            width: "100%",
            maxWidth: 650,
            aspectRatio: "1 / 1", // square like exported
            borderRadius: 8,
            outline: "none",
            backgroundColor: "#000",
            objectFit: "contain",
      ...
      {/* === two visual indentations after each visualization === */}
      <div style={{ height: 24 }} />
      <div style={{ height: 24 }} />
    </div>
  );
  ...
  const renderSideDivider = () => (
    <div style={{ margin: "30px 0 10px", textAlign: "center" }}>
      ...
      {/* a little space after the divider */}
      <div style={{ height: 24 }} />
    </div>
  );
  ...
  return (
    <Layout title="Self Titled">
      ...
      {/* === TEASER IMAGE LINKING TO /selftitled (kept) === */}
...
>
  ...
  >
      ...
      {renderVideo(iammmwMp4, "its a mans mans mans world - James Brown", "iammmw")}
      {renderVideo(
        daytripperMp4,
        "day tripper - Lennon & McCartney",
        "daytripper"
      )}
      {renderVideo(bachcelloMp4, "Sarabande in G - Johann Sebastian Bach", "bachcello")}
...
>
  ...
  <p style={{ margin: 0 }}>
    Sax — Curtis Johnson, Yoko Suzuki, Kenny Powell, Rick Matt, Joe Scheller
  </p>
  ...
  <p style={{ margin: 0 }}>
    Trombone — Nick McFeeters, Maxine Van Nortwick, Brendan Long, Rory Feathers
  </p>
  <p style={{ margin: 0 }}>
    Sax — Anna Makoul, Dorothy Vogel, Michael Levin, Carson Hertick, Michael Evans
  </p>
  ...
  <p style={{ fontStyle: "italic", opacity: 0.85 }}>
    * All unmentioned tracks performed entirely by Joe Pearson
  </p>
</div>


      {/* === HOME PAGE DEV NOTE + SOCIALS (kept) === */}
      ...
      <div style={styles.note}>
        ...
        <p style={{ margin: 0 }}>-</p>
        <p style={{ margin: 0 }}>
          P.S. click the album cover to learn more
        </p>
      </div>
