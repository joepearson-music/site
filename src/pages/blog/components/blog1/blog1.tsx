...
const BlogPost1: React.FC = () => {
  return (
    <div style={styles.container}>
      ...
      <Figure
        imageSrc={screen1}
        altText="Carbon Calculator Screenshot"
        caption="First screen of the first version of the carbon calculator on our website"
        size="small"
      ...
      <Figure
        imageSrc={screen2}
        altText="Carbon Calculator Screenshot"
        caption="Transportation screen of the first version of the carbon calculator on our website"
        size="small"
        title="Screen 2: Transportation
"
      />
      <Figure
        imageSrc={screen3}
        altText="Carbon Calculator Screenshot"
        caption="Diet screen of the first version of the carbon calculator on our website"
        size="small"
        title="Screen 3: Diet"
      />
      <Figure
        imageSrc={screen4}
        altText="Carbon Calculator Screenshot"
        caption="Energy screen of the first version of the carbon calculator on our websitee"
        size="small"
        title="Screen 4: Energy/Utilities"
      />
      <Figure
        imageSrc={screen5}
        altText="Carbon Calculator Screenshot"
        caption="First version of the breakdown screen"
        size="small"
        title="Screen 5: Breakdown"
      />
      <Figure
        imageSrc={screen6}
        altText="Carbon Calculator Screenshot"
        caption="Email of the first version of the carbon calculator"
        size="small"
        title="Screen 6: Email Returned to User"
      />
